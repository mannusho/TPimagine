...
<main>
    ...
    <form action="ac_crop.php" method="POST" name="crop" id="crop">
        <div class="form-group row">
            ...
            <div class="col-md-6 mb-3" style="text-align: center;">
                <label for="basic-url"> Cortar la imagen </label>
                    ...
                    <div class="input-group mb-3">
                        <span><i> El sistema de coordenadas comienza en a, b (0,0), indica un punto donde posicionarnos. </i></span>
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="puntoa">Punto A </span>
                            </div>
                        <input type="text" class="form-control" id="puntoa" name="puntoa" aria-describedby="color">
                         </div>
                         <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="puntob">Punto B </span>
                            </div>
                        <input type="text" class="form-control" id="puntob" name="puntob" aria-describedby="color">
                         </div>
